...
let defaultPM2_5Range = [Breakpoints(bpLow: 0, bpHigh: 20, lowScore: 0.0, score: 0.10),
                         Breakpoints(bpLow: 21, bpHigh: 50, lowScore: 0.11, score: 0.20),
                         Breakpoints(bpLow: 51, bpHigh: 90, lowScore: 0.21, score: 0.40),
                         Breakpoints(bpLow: 91, bpHigh: 140, lowScore: 0.41, score: 0.60),
                         Breakpoints(bpLow: 141, bpHigh: 500, lowScore: 0.61, score: 1.0)]

let defaultPM10Range = [Breakpoints(bpLow: 0, bpHigh: 25, lowScore: 0.0, score: 0.10),
                        Breakpoints(bpLow: 26, bpHigh: 75, lowScore: 0.11, score: 0.20),
                        Breakpoints(bpLow: 76, bpHigh: 125, lowScore: 0.21, score: 0.40),
                        Breakpoints(bpLow: 126, bpHigh: 200, lowScore: 0.41, score: 0.60),
                        Breakpoints(bpLow: 201, bpHigh: 500, lowScore: 0.61, score: 1.0)]

let defaultVOCRange = [Breakpoints(bpLow: 0, bpHigh: 50, lowScore: 0.0, score: 0.10),
                       Breakpoints(bpLow: 51, bpHigh: 100, lowScore: 0.11, score: 0.20),
                       Breakpoints(bpLow: 101, bpHigh: 150, lowScore: 0.21, score: 0.40),
                       Breakpoints(bpLow: 151, bpHigh: 200, lowScore: 0.41, score: 0.60),
                       Breakpoints(bpLow: 201, bpHigh: 500, lowScore: 0.61, score: 1.0)]

let defaultCORange = [Breakpoints(bpLow: 0, bpHigh: 30, lowScore: 0.0, score: 0.10),
                      Breakpoints(bpLow: 31, bpHigh: 70, lowScore: 0.11, score: 0.20),
                      Breakpoints(bpLow: 71, bpHigh: 150, lowScore: 0.21,  score: 0.40),
                      Breakpoints(bpLow: 151, bpHigh: 300, lowScore: 0.31, score: 0.60),
                      Breakpoints(bpLow: 301, bpHigh: 1000, lowScore: 0.61, score: 1.0)]

let defaultCO2Range = [Breakpoints(bpLow: 0, bpHigh: 500, lowScore: 0.0, score: 0.10),
                       Breakpoints(bpLow: 501, bpHigh: 750, lowScore: 0.11, score: 0.20),
                       Breakpoints(bpLow: 751, bpHigh: 1000, lowScore: 0.21, score: 0.40),
                       Breakpoints(bpLow: 1001, bpHigh: 3000, lowScore: 0.41, score: 0.60),
                       Breakpoints(bpLow: 3001, bpHigh: 5000, lowScore: 0.61, score: 1.0)]
